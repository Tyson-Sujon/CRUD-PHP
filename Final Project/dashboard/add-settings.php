              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Tagline: <span class="tx-danger">*</span></label>
                   <input type="text" class="form-control" value="" id="tagline" placeholder="Enter Tagline" name="tagline">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Phone: <span class="tx-danger">*</span></label>
                   <input type="text" class="form-control" value="" id="phone" placeholder="Enter phone" name="phone">
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Office Address: <span class="tx-danger">*</span></label>
                   <input type="text" class="form-control" value="" id="office_address" placeholder="Enter Office Address" name="office_address">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">Copyright: <span class="tx-danger">*</span></label>
                   <input type="text" class="form-control" value="" id="copyright" placeholder="Enter Copyright" name="copyright">
                </div>
              </div>
